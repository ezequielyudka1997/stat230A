...
processed_data <- processed_data %>%
  mutate(
    DIS = as.numeric(DIS) - 1, #I suggest this instead ifelse(DIS == 2, 1, 0)
...
```{r setup, include=FALSE}
employment_status_model <- glm(Unemployed ~  SEX + DIVISION + Citizen + ENG + AGEP + DIS + PAP + MAR + High_School_Grad + Bachelors_Degree + HISP_dummy + Asian, data = processed_data, family = binomial())
