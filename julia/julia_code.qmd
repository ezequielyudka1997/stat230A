...
```{r, eval = FALSE}
model1 = lm(WAGP ~ as.factor(RAC1P) + AGEP +   SEX*Citizen + as.factor(ENG) + SEX*DIS + wb50birth+ Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + HISP_dummy + as.factor(MAR) + PAP + HINS4 + Years_in_US, data = immigrants_only2)
```
...
ggplot(plot_data, aes(x = Feature, y = Coefficient)) +
    ...
    coord_flip() +
    labs(title = "Coefficient Plot with EHW Robust Standard Errors",
         subtitle = "Model (1.2): all non-Immigrants",
         x = "Feature",
         y = "Coefficient") +
    theme_minimal() + theme(axis.text.y = element_text(size = 8))
```
...
```{r, eval=FALSE}
model2 = lm(WAGP ~ AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + wb50birth+ Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR) + as.factor(POBP) + Years_in_US, data = asian_only_im)
```
...
ggplot(plot_data, aes(x = Feature, y = Coefficient)) +
    ...
    coord_flip() +
    labs(title = "Coefficient Plot with EHW Robust Standard Errors",
         subtitle = "Model (3): all Asian Immigrants",
         x = "Feature",
         y = "Coefficient") +
    theme_minimal() + theme(axis.text.y = element_text(size = 8))
```
...
```{r, eval=FALSE}
model3 = lm(WAGP ~ as.factor(RAC1P) + AGEP + SEX*Citizen + as.factor(ENG) + SEX*DIS + wb50birth+ Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR) + as.factor(POBP) + Years_in_US, data = hisp_only_im)
```
...
ggplot(plot_data, aes(x = Feature, y = Coefficient)) +
    ...
    coord_flip() +
    labs(title = "Coefficient Plot with EHW Robust Standard Errors",
         subtitle = "Model (5): all Hispanic Immigrants",
         x = "Feature",
         y = "Coefficient") +
    theme_minimal() + theme(axis.text.y = element_text(size = 8))
```
...
ggplot(plot_data, aes(x = Feature, y = Coefficient)) +
    ...
    coord_flip() +
    labs(title = "Coefficient Plot with EHW Robust Standard Errors",
         subtitle = "Model (6): all Hispanics",
         x = "Feature",
         y = "Coefficient") +
    theme_minimal() + theme(axis.text.y = element_text(size = 8))
```
