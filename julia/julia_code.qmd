...
```{r}
mini_model = lm(WAGP ~ as.factor(RAC1P) + AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad  + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR), data = processed_data2)
```
...
```{r}
model0 = lm(WAGP ~ as.factor(RAC1P) + AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + wb50birth + as.factor(ST) + High_School_Grad + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR) + immigrant, data = processed_data2)
```
...
### mini model and summary
```{r}
mini_model = lm(WAGP ~ as.factor(RAC1P) + AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad  + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR), data = immigrants_only2)
```
...
### mini model and summary
```{r}
mini_model = lm(WAGP ~ as.factor(RAC1P) + AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad  + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR), data = non_immigrants)
```
...
### model 1 for asian immigrants accounting for country of origin

```{r}
model2 = lm(WAGP ~ AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + wb50birth+ Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + HISP_dummy + PAP + HINS4 + as.factor(MAR) + as.factor(POBP), data = asian_only_im)
```
...
### mini model and summary: for asian immigrants accounting for country of origin
```{r}
mini_model = lm(WAGP ~ AGEP +  SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR) + as.factor(POBP), data = asian_only_im)
```
...
### model 2 for all asians: using immigrants instead of citizen for comparison 

```{r}
model2.2 = lm(WAGP ~ AGEP + SEX*immigrant + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR) , data = asian_only)
```
...
### HISP model 1 for immigrants by POBP

```{r}
model3 = lm(WAGP ~ as.factor(RAC1P) + AGEP + SEX*Citizen + as.factor(ENG) + SEX*DIS + wb50birth+ Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR) + as.factor(POBP), data = hisp_only_im)
```
...
### mini model and summary
```{r}
mini_model = lm(WAGP ~  as.factor(RAC1P) + AGEP + SEX*Citizen + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR) + as.factor(POBP), data = hisp_only_im)
```
...
### HISP model 2 for all hispanics using immigrant for comparison

```{r}
model2.2 = lm(WAGP ~ as.factor(RAC1P) + AGEP + SEX*immigrant + as.factor(ENG) + SEX*DIS + Unemployed + as.factor(ST) + High_School_Grad + Bachelors_Degree + PAP + HINS4 + as.factor(MAR), data = hisp_only)
```
